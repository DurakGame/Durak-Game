...
toggle++
    ...
    for(let i=0;i<document.getElementsByClassName('cardy').length;i++){
        ...
        if(document.getElementsByClassName('cardy')[i].style.borderColor=="yellow"){
            ...
            if(zz==0){
                document.getElementById("infobox").style.fontSize="initial";  document.getElementById("infobox").style.lineHeight="normal"   
...
if(robotdeck.length==0){
    ...
    document.getElementById("infobox").style.fontSize="initial"   
...
function GiveExtra(){
    ...
    document.getElementById("infobox").style.fontSize="smaller"
...
function PlayerNum(x){
    ...
    //document.getElementById('buttons').style.visibility='hidden'
        ...
        for(let i=0;i<document.body.childElementCount;i++){
            if(document.body.children[i].id!="playingarea"&&document.body.children[i].id!="playersbuttons")
    ...
    let z=document.createElement("div")
    z.className="box1 sb6"
    z.id="infobox"

    let a=document.createElement("p")
    a.innerHTML="I'm a speech bubble"
    z.appendChild(a)
    ...
    h.id="rowTwo"
    h.appendChild(document.getElementById('playingarea'))
    ...
    k.id="rowFour"
    k.appendChild(document.getElementById('playersbuttons'))

    e.appendChild(f)
    e.appendChild(h)
    e.appendChild(i)
    e.appendChild(k)
    swapStyleSheet("duraka.css"); 
